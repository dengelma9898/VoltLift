...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "VoltLift")
...
extension PersistenceController {
    ...
    func performMigrationIfNeeded() throws -> Bool {
        ...
        try createBackup(storeURL: storeURL)
        ...
        do {
            ...
            try restoreFromBackup(storeURL: storeURL)
    ...
    func validateDataIntegrity() throws {
        ...
        try validateUserEquipment(context: context)
        
        // Validate WorkoutPlan entities
        try validateWorkoutPlans(context: context)
        
        // Validate PlanExercise entities
        try validatePlanExercises(context: context)
        
        // Validate ExerciseMetadata entities
        try validateExerciseMetadata(context: context)
    }
    ...
    private func handleDataCorruption() -> Bool {
        ...
        hasCorruption = cleanupCorruptedUserEquipment(context: context) || hasCorruption
        
        // Clean up corrupted WorkoutPlans
        hasCorruption = cleanupCorruptedWorkoutPlans(context: context) || hasCorruption
        
        // Clean up corrupted PlanExercises
        hasCorruption = cleanupCorruptedPlanExercises(context: context) || hasCorruption
        
        // Clean up corrupted ExerciseMetadata
        hasCorruption = cleanupCorruptedExerciseMetadata(context: context) || hasCorruption
    ...
    private func cleanupCorruptedUserEquipment(context: NSManagedObjectContext) -> Bool {
        ...
        do {
            ...
            let deleteRequest = NSBatchDeleteRequest(fetchRequest: NSFetchRequest<NSFetchRequestResult>(entityName: "UserEquipment"))
