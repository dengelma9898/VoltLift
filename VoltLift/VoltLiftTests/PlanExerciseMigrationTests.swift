...
final class PlanExerciseMigrationTests: XCTestCase {
    ...
    func testMigrateSinglePlanExerciseFromLegacyFormat() throws {
        ...
        try self.persistenceController.migratePlanExerciseData()
    ...
    func testMigrationValidatesLegacyData() throws {
        ...
        XCTAssertThrowsError(try self.persistenceController.migratePlanExerciseData()) { error in
            ...
            if case let .validationFailed(message) = migrationError {
                XCTAssertTrue(
                    message.contains("Invalid legacy values"),
                    "Error message should mention invalid legacy values"
                )
            } else {
    ...
    func testValidationAfterMigration() throws {
        ...
        XCTAssertNoThrow(try self.persistenceController.validateDataIntegrity())
    }
    ...
    func testMigrationWithZeroWeight() throws {
        ...
        // When: Migration is performed
        XCTAssertNoThrow(try self.persistenceController.migratePlanExerciseData())
